...
public abstract class UserMapper {
    ...
    public static User fromCreateThirdPartyDto(CreateThirdPartyDto createThirdPartyDto) {
        return User.builder().name(createThirdPartyDto.getName()).userRole(createThirdPartyDto.getUserRole()).externalAccount(createThirdPartyDto.getExternalAccount()).build();
    }

    public static KeycloakUserDto toKeycloakUserDto(User user) {
        return KeycloakUserDto.builder().userName(user.getName()).password(user.getName()).build();
    }
}
