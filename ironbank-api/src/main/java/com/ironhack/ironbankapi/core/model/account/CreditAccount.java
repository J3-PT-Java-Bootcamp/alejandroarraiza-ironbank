...
public class CreditAccount extends Account{
    ...
    public CreditAccount(String accountNumber, Money balance, User primaryOwner, User secondaryOwner, AccountStatus status, String secretKey, Money creditLimit, double interestRate) {
